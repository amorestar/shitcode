    ...
    do
        ...
        do
            local Lines = {
                ...
                {
                    Position = UDim2.fromOffset(48, 0), -- Изменил с UDim2.fromScale(0.3, 0) на фиксированные 48 пикселей для узкой панели табов
        ...
        Tabs = New("ScrollingFrame", {
            ...
            BorderSizePixel = 0,
            Position = UDim2.fromOffset(1, 49),
            Size = UDim2.fromOffset(47, MainFrame.Size.Y.Offset - 70),
        ...
        do
            ...
            if Icon then
                ...
                TabButton.MouseEnter:Connect(function()
                    IconContainer.BackgroundColor3 = Color3.fromRGB(55, 55, 55)
                    TabIcon.ImageColor3 = Color3.fromRGB(255, 255, 255)
                end)
                
                TabButton.MouseLeave:Connect(function()
                    IconContainer.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
